...
{
	// If you want to use different chartsets in your exe
	// Uncomment the following and use Create(...) directly instead of
	// creating in the Dialog Editor of VS
    ...
    //HINSTANCE hInst = chartApp.hInst;
